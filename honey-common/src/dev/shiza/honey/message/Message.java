...
/**
* Represents an immutable message paired with a context for placeholders.
* The context is used to replace placeholders within the message content.
*/
public record Message(String content, PlaceholderContext context) {
  ...
  /**
  * Creates a new {@code Message} instance with specified content.
  * A new placeholder context is also initialized for this message.
  *
  ...
  */
  ...
  /**
  * Applies a {@code UnaryOperator} that modifies the placeholder context,
  * and returns a new {@code Message} instance with the modified context.
  *
